...
import Image1 from "../../public/category/gaming.png";
import Image2 from "../../public/category/vr.png";
import Image3 from "../../public/category/speaker.png";
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="col-span-2 py-10 pl-5 bg-linear-to-br from-gray-400/90 to-gray-100 text-white rounded-3xl relative h-80 flex items-en shadow-xl">
            ...
            <img
              src={Image1}
              alt=""
              className="w-62.5 absolute top-1/2 -translate-y-1/2 lg:translate-0 right-0 lg:top-10"
            />
          </div>
          {/* Second Column */}
          <div className="py-10 pl-5 bg-linear-to-br from-brandGreen/90 to-brandGreen/90 text-white rounded-3xl relative h-80 flex items-start shadow-xl">
            <div>
              <div className="mb-4">
                <p className="mb-0.5 text-white">Explore</p>
