...
import Image1 from "../../public/category/earphone.png";
import Image2 from "../../public/category/watch.png";
      ...
      <div className=" sm:p-12 p-4">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="py-10 pl-5 bg-linear-to-br from-black/90 to-black/70 text-white rounded-3xl relative h-80 flex items-end shadow-xl">
            ...
            <img src={Image1} alt="earphone img" className="w-[320px] absolute bottom-0" />
          </div>
          {/* Second Column */}
          <div className="py-10 pl-5 bg-linear-to-br from-brandYellow to-brandYellow/90 text-white rounded-3xl relative h-80 flex items-end shadow-xl">
            ...
            <img
              src={Image2}
              alt=""
              className="w-[320px] absolute md:-right-10 lg:-right-16 top-10 md-top-10"
            />
          </div>
          {/* Third Column */}
          <div className="col-span-2 py-10 pl-5 bg-linear-to-br from-primary to-primary/90 text-white rounded-3xl relative h-80 flex items-end shadow-xl">
            <div>
              <div className="mb-4">
                <p className="mb-0.5 text-white text-lg">Buy Best</p>
                <p className="text-3xl font-semibold mb-0.5">Branded</p>
                <p className="text-4xl xl:text-5xl font-bold opacity-40 mb-2">
                  Laptops
                </p>
                <Button
            ...
            <img
              src={Image3}
              alt=""
              className="w-62.5 sm:w-70 absolute top-1/2 -translate-y-1/2 lg:translate-0 right-0 lg:top-5"
            />
          </div>
        </div>
      </div>
